...
public class ExceptionResponse {
    ...
    public static class ResponseBuilder {
        ...
        public com.users.exception.ExceptionResponse get() {
            return new com.users.exception.ExceptionResponse(errorCode, errorMessage, timestamp, stackTrace, errors, params);
        }
